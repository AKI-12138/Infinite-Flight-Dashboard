...
- **强大的筛选与对比** — 快捷栏管基础（年、月、航司、机型、国家、Scope），其余都在 **⚙ 高级筛选**面板：出发/到达的机场、城市、国家与大洲，洲内/跨洲，飞行时长（区间或自定义范围）— 还有带搜索的菜单、一键**预设**、以及你自己**保存的预设**。也可直接点击图表柱下钻。内置同比对比，"今年比去年多飞了多少？"一目了然
...
- **测试** — 纯逻辑（normalize / parse / compute / filters）由 Vitest 覆盖
